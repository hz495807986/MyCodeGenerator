...
{
    public partial class FormDBHelper : Form
    {
        string name = "";
        ...
        private void FormDBHelper_Load(object sender, EventArgs e)
        {
            load();
            this.textBox1.Text = name;
        }
        private void btnWriteToDesk_Click(object sender, EventArgs e)
        {
