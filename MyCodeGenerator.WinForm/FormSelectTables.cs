...
{
    public partial class FormSelectTables : Form
    {
        List<string> list = null;
        public FormMain fmain;
        List<Panel> listpanel = new List<Panel>();
        public FormSelectTables()
        {
            InitializeComponent();
        }
        public FormSelectTables(List<string> list)
        {
            InitializeComponent();
            this.list = list;
        }
        private void FormSelectTables_Load(object sender, EventArgs e)
        {
